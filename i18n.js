...
const translations = {
  zh: {
    ...
    "label.baseAtk": "基礎攻擊力",
    "label.baseHp": "基礎血量",
    "label.astroLevel": "星座等級",
    "label.astroLevelStats": "星座加成 (攻擊／血量／建築物傷害)",
    "astro.notSelected": "未選擇",
    "astro.statsReadout": "攻擊 +{atk}／血量 +{hp}／建傷 +{build}",
  ...
  en: {
    ...
    "label.astroLevel": "Constellation Level",
    "label.astroLevelStats": "Constellation Bonus (ATK／HP／Building Dmg)",
    "astro.notSelected": "Not selected",
    "astro.statsReadout": "ATK +{atk} / HP +{hp} / Building Dmg +{build}",
  ...
  es: {
    ...
    "label.astroLevel": "Nivel de constelación",
    "label.astroLevelStats": "Bono de constelación (Ataque／Vida／Daño a edificios)",
    "astro.notSelected": "Sin seleccionar",
    "astro.statsReadout": "Ataque +{atk} / Vida +{hp} / Daño a edificios +{build}",
  ...
  fr: {
    ...
    "label.astroLevel": "Niveau de constellation",
    "label.astroLevelStats": "Bonus de constellation (Attaque／PV／Dégâts aux bâtiments)",
    "astro.notSelected": "Non sélectionné",
    "astro.statsReadout": "Attaque +{atk} / PV +{hp} / Dégâts aux bâtiments +{build}",
  ...
  ja: {
    ...
    "label.baseAtk": "基礎攻撃力",
    "label.baseHp": "基礎HP",
    "label.astroLevel": "コンステレーションレベル",
    "label.astroLevelStats": "コンステレーションボーナス（攻撃力／HP／建物ダメージ）",
    "astro.notSelected": "未選択",
    "astro.statsReadout": "攻撃力 +{atk}／HP +{hp}／建物ダメージ +{build}",
