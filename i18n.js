...
const translations = {
  zh: {
    ...
    "label.baseAtk": "基礎攻擊力",
    "label.baseHp": "基礎血量",
    "label.astroAtk": "星座攻擊力",
    "label.astroHp": "星座血量",
    "label.astroBuildingAtk": "星座建築物傷害",
  ...
  en: {
    ...
    "label.astroAtk": "Constellation Attack",
    "label.astroHp": "Constellation HP",
    "label.astroBuildingAtk": "Constellation Building Damage",
  ...
  es: {
    ...
    "label.astroAtk": "Ataque de constelación",
    "label.astroHp": "Vida de constelación",
    "label.astroBuildingAtk": "Daño a edificios de constelación",
  ...
  fr: {
    ...
    "label.astroAtk": "Attaque de constellation",
    "label.astroHp": "PV de constellation",
    "label.astroBuildingAtk": "Dégâts aux bâtiments de constellation",
  ...
  ja: {
    ...
    "label.baseAtk": "基礎攻撃力",
    "label.baseHp": "基礎HP",
    "label.astroAtk": "コンステレーション攻撃力",
    "label.astroHp": "コンステレーションHP",
    "label.astroBuildingAtk": "コンステレーション建物ダメージ",
